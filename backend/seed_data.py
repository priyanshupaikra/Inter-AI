...
print(f"{'✅ Created' if created else 'ℹ️  Found'} interviewer: {interviewer1.name}")
...
print(f"{'✅ Created' if created else 'ℹ️  Found'} interviewer: {interviewer2.name}")
...
for student_data in students_data:
    ...
    print(f"{'✅ Created' if created else 'ℹ️  Found'} student: {student.name}")
...
for i, session_data in enumerate(sessions_data):
    ...
    print(f"{'✅ Created' if created else 'ℹ️  Found'} session: {session.title}")
...
for session, questions_data in zip(sessions, questions_sets):
    for question_data in questions_data:
        ...
        if created:
            print(f"  ✅ Added question {question.order} to {session.title}")
